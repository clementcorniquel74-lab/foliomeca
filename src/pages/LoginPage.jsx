...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-base-950 px-4 py-10 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative animate-fade-in">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-base-400 text-sm mt-1 text-center">
            {t('login.tagline')}
          </p>
        </div>
